...
echo 'export PATH=/home/leahxu/cloudera/cdh5.1/hadoop-2.3.0-cdh5.1.2/bin:/home/leahxu/cloudera/cdh5.1/hadoop-2.3.0-cdh5.1.2/sbin:/usr/lib/jvm/java-7-openjdk-amd64/jre/bin:${PATH}' >> ~/.profile
source $HOME/.profile
cd -
